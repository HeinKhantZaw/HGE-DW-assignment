                ...
                <div class="section__intro u-s-m-b-16">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section__text-wrap">
                                    <h1 class="section__heading u-c-secondary u-s-m-b-12">TOP Trending PRODUCTS</h1>
                                ...
                                <div class="filter-category-container">
                                    ...
                                    <div class="filter__category-wrapper">
                                        ...
                                        <button class="btn filter__btn filter__btn--style-1" type="button"
                                                data-filter=".whole-body">WHOLE-BODY
                                        </button>
                                    </div>
                                    <div class="filter__category-wrapper">

                                        <button class="btn filter__btn filter__btn--style-1" type="button"
                                                data-filter=".weight-bench">WEIGHT-BENCH
                                        </button>
                                    </div>
                                    <div class="filter__category-wrapper">

                                        <button class="btn filter__btn filter__btn--style-1" type="button"
                                                data-filter=".barbells">Barbells
                                        </button>
                                    </div>
                                    <div class="filter__category-wrapper">

                                        <button class="btn filter__btn filter__btn--style-1" type="button"
                                                data-filter=".treadmill">Treadmill
                                        </button>
                                    </div>
                                </div>
                                <div class="filter__grid-wrapper u-s-m-t-30">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item whole-body">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">Red Wireless whole-body</a></span>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item whole-body">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">Yellow Wireless whole-body</a></span>
                                                <div class="product-o__rating gl-rating-style"><i
                                                            class="fas fa-star"></i><i
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item barbells">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item treadmill">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">Canon treadmill Camera 4k</a></span>
                                                <div class="product-o__rating gl-rating-style"><i
                                                            class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item treadmill">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">Nikon treadmill Camera 4k</a></span>
                                                <div class="product-o__rating gl-rating-style"><i
                                                            class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item weight-bench">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">weight-bench RAM 4GB New</a></span>
                                                <div class="product-o__rating gl-rating-style"><i
                                                            class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item weight-bench">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">weight-bench RAM 8GB New</a></span>
                                                <div class="product-o__rating gl-rating-style"><i
                                                            class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item weight-bench">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <span class="product-o__name">
                                                    ...
                                                    <a href="product-detail.html">weight-bench RAM 16GB New</a></span>
                                                <div class="product-o__rating gl-rating-style"><i
                                                            class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                ...
                                <div class="bp-mini bp-mini--img u-h-100">
                                    ...
                                    <div class="bp-mini__content">
                                        ...
                                        <p class="bp-mini__p">
                                            ...
                                            failures will no longer be an issue!
                                        </p>
                                        <div class="blog-t-w">
